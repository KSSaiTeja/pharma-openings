#!/usr/bin/env npx tsx
/**
 * Delete ALL jobs (and linked applications / saved jobs). Talent pool is kept.
 *
 * Usage:
 *   npm run reset:jobs
 *   npm run reset:jobs -- --dry-run
 */
...
async function deleteAll(
  ...
  table: "saved_jobs" | "applications" | "jobs",
  dryRun: boolean,
): Promise<number> {
...
async function main(): Promise<void> {
  ...
  console.log(
    dryRun
      ...
      : "\nDone. Job list is empty. Candidates / talent pool were not removed.",
  );
}
